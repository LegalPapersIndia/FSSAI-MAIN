...
import { FaChalkboardTeacher, FaVideo, FaShieldAlt, FaGlobe, FaCertificate, FaClock } from 'react-icons/fa';
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-green-100 group">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Complete guide to Food Registration licensing, documentation, FSMS implementation, 
                and how to stay compliant with current regulations.
              </p>
              <div className="flex items-center gap-2 text-sm text-green-700">
                <FaClock /> <span>4 Hours • Interactive Session</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-green-100 group">
              ...
              <div className="flex items-center gap-2 text-sm text-green-700">
                <FaClock /> <span>3 Hours • Hands-on Approach</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-green-100 group">
              ...
              <div className="flex items-center gap-2 text-sm text-green-700">
                <FaClock /> <span>3.5 Hours • Case Studies</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-green-100 group">
              ...
              <div className="flex items-center gap-2 text-sm text-green-700">
                <FaClock /> <span>4 Hours • Practical Examples</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: <FaVideo className="text-orange-600" size={26} />,
              ...
              {
                icon: <FaCertificate className="text-orange-600" size={26} />,
